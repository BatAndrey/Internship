...
def front_back(a, b):
    if len(a) % 2 == 0 and len(b) % 2 == 0:
        ...
        back_a = a[len(a)//2:len(a):1]
        front_b = b[0:len(b) // 2:1]
        back_b = b[len(b) // 2:len(b):1]
        return front_a + front_b + back_a + back_b
    elif len(a) % 2 > 0 and len(b) % 2 > 0:
        front_a = a[0:len(a) // 2 + 1:1]
        back_a = a[len(a) // 2 + 1:len(a):1]
        front_b = b[0:len(b) // 2 + 1:1]
        back_b = b[len(b) // 2 + 1:len(b):1]
        return front_a + front_b + back_a + back_b
    elif len(a) % 2 == 0 and len(b) % 2 > 0:
        front_a = a[0:len(a)//2:1]
        back_a = a[len(a)//2:len(a):1]
